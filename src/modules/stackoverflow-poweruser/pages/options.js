...
function saveSettings() {
	...
	let expandAllCommentsOnCtrlfEnabled = document.getElementById(
		'expandAllCommentsOnCtrlfEnabled',
	).checked
...
function restoreSettings() {
	chrome.storage.sync.get(
		...
		function (items) {
			...
			document.getElementById('autoScrollFirstAnswerEnabled').checked =
				items.autoScrollFirstAnswerEnabled
			document.getElementById('showSidebarEnabled').checked = items.showSidebarEnabled
			document.getElementById('navigationArrowKeysEnabled').checked =
				items.navigationArrowKeysEnabled
			document.getElementById('autoExpandVotesCountEnabled').checked =
				items.autoExpandVotesCountEnabled
			document.getElementById('stickyScrollOnUpvoteButtons').checked =
				items.stickyScrollOnUpvoteButtons
			document.getElementById('expandAllCommentsOnCtrlfEnabled').checked =
				items.expandAllCommentsOnCtrlfEnabled
